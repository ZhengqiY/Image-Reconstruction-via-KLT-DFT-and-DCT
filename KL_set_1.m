...
reconst = V*KLCoef';
%  NOTE: The following for loop is generating 20 reconstructed images and saving
%  these images so that I commentted this part in order to avoid repeating
%  doing the same task each time.
...
% % %     saveas(gcf, sprintf('reconst set 1 %d.jpg', image_index));
% % %     close all
% % % end
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
title('Set 1 RMSE vs KLCoef Num');